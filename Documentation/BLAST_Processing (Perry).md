...
### WP2C Glatt (Switzerland)

> The analysis block for the Glatt follows the same structure as WP2A. River-specific notes:
> - Species removed: *Sardina pilchardus* (European pilchard — marine contaminant)
> - Sites are ordered manually along the river gradient for plotting: GL01 (lake outlet) → GL13, GL02–GL12
> - Column index range for normalisation: `1:25`
...
# Sites ordered manually from lake outlet (GL01) downstream for interpretable plots
...
### WP2C Towy (Carmarthenshire)

> River-specific notes:
> - Species removed: *Platichthys stellatus* (Starry flounder — Pacific, non-native)
> - Column index range for normalisation: `1:10`
...
### WP2C Gwash (Leicestershire)

> River-specific notes:
> - Species removed: *Sardina pilchardus*
> - Column index range for normalisation: `1:23`
...
### WP2C Skaneateles (New York)

> River-specific notes:
> - No species excluded in the current version (the *Platichthys stellatus* exclusion line is commented out — review if re-running)
> - Column index range for normalisation: `1:22`
...
#REMOVE CLEAR FISH THAT ARE LIEKLY CONSUMED BY HUAMNS AND NOT NATIVE
# NOTE: Platichthys stellatus exclusion is currently commented out — reinstate if needed
